...
|------------- | ------------- | ------------- | -------------|
| **200** | The matching groups, each with its access state for the file | [**GroupArrayWrapper**](../../models/group-array-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

...
|------------- | ------------- | ------------- | -------------|
| **200** | List of users with their access rights to the file | [**MentionWrapperArrayWrapper**](../files.md#model-mentionwrapperarraywrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

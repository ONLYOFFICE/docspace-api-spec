...
|------------- | ------------- | ------------- | -------------|
| **200** | The portal members who can read the file, ordered by display name | [**MentionWrapperArrayWrapper**](../files.md#model-mentionwrapperarraywrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

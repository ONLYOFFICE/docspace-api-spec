...
|------------- | ------------- | ------------- | -------------|
| **200** | The space taken by documents in each section, in bytes | [**FilesStatisticsResultWrapper**](../files.md#model-filesstatisticsresultwrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

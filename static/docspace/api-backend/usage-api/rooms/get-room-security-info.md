...
|------------- | ------------- | ------------- | -------------|
| **200** | One page of the room access entries, ordered by role and then by name | [**FileShareArrayWrapper**](../models/file-share-array-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

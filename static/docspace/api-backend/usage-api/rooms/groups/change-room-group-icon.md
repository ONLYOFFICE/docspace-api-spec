...
| **IconRequest** | body | [**IconRequest**](../../models/icon-request.md) | The icon to give the group. A body that leaves the icon out is accepted and changes nothing. | [optional] |

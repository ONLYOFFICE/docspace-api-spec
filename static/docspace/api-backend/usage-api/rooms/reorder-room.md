...
|------------- | ------------- | ------------- | -------------|
| **200** | The room whose contents were renumbered | [**FolderIntegerWrapper**](../models/folder-integer-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

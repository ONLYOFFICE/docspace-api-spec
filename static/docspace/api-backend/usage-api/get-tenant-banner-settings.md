...
|------------- | ------------- | ------------- | -------------|
| **200** | Whether the portal's promotional banners are currently hidden | [**TenantBannerSettingsWrapper**](../api.md#model-tenantbannersettingswrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

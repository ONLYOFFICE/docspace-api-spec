...
|------------- | ------------- | ------------- | -------------|
| **200** | The matching accounts, each with its access state for the file | [**EmployeeFullArrayWrapper**](../people.md#model-employeefullarraywrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

...
|------------- | ------------- | ------------- | -------------|
| **200** | Claims | [**ObjectWrapper**](../people.md#model-objectwrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |
| **401** | Unauthorized | - | - |
...
[**ObjectWrapper**](../people.md#model-objectwrapper)

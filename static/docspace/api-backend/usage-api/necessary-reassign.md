...
|------------- | ------------- | ------------- | -------------|
| **200** | True if the data of the user has to be reassigned before the removal or the type change | [**BooleanWrapper**](../people.md#model-booleanwrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

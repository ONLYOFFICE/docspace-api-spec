...
|------------- | ------------- | ------------- | -------------|
| **200** | The spreadsheet with its Custom Filter state as it now stands | [**FileWrapper**](../files.md#model-filewrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

...
|------------- | ------------- | ------------- | -------------|
| **200** | List of company white label settings | [**CompanyWhiteLabelSettingsArrayWrapper**](../api.md#model-companywhitelabelsettingsarraywrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

...
|------------- | ------------- | ------------- | -------------|
| **200** | A page of matching accounts, with their full profiles | [**EmployeeFullArrayWrapper**](../people.md#model-employeefullarraywrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

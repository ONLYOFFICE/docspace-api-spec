...
|------------- | ------------- | ------------- | -------------|
| **200** | List of connected providers information | [**ThirdPartyParamsArrayWrapper**](../files.md#model-thirdpartyparamsarraywrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

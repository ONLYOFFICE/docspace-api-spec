...
|------------- | ------------- | ------------- | -------------|
| **200** | The number of active Docs Connect users of the portal and the date the count starts from | [**DocsCloudUsageWrapper**](../api.md#model-docscloudusagewrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

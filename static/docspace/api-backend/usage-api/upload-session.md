...
|------------- | ------------- | ------------- | -------------|
| **200** | Current state of the upload session and, once the upload is complete, the uploaded file | [**UploadSessionResponseIntegerWrapper**](../files.md#model-uploadsessionresponseintegerwrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

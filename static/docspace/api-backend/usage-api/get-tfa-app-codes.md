...
|------------- | ------------- | ------------- | -------------|
| **200** | List of TFA application codes | [**TfaAppCodeArrayWrapper**](../api.md#model-tfaappcodearraywrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

...
|------------- | ------------- | ------------- | -------------|
| **200** | The URL the user has to open to set a new password, or an empty result when the operation failed | [**StringWrapper**](../../models/string-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

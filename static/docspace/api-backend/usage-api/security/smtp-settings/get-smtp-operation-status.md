...
|------------- | ------------- | ------------- | -------------|
| **200** | The state of the test message of the portal, or an empty answer when no test is on record | [**SmtpOperationStatusRequestsWrapper**](../../models/smtp-operation-status-requests-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

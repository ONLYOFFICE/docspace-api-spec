...
|------------- | ------------- | ------------- | -------------|
| **200** | Ok | [**IAccountEntryArrayWrapper**](../people.md#model-iaccountentryarraywrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |
...
[**IAccountEntryArrayWrapper**](../people.md#model-iaccountentryarraywrapper)

...
|------------- | ------------- | ------------- | -------------|
| **200** | The display name of the calling user, or an empty result when the operation failed | [**StringWrapper**](../api.md#model-stringwrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

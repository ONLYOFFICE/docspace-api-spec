...
| **SecurityInfoSimpleRequestDto** | body | [**SecurityInfoSimpleRequestDto**](../../models/security-info-simple-request-dto.md) | The rights to apply to the folder, and whether to announce them by mail. | [required] |

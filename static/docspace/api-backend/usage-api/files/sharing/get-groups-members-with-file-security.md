...
|------------- | ------------- | ------------- | -------------|
| **200** | The members of the group with the access each of them has on the file | [**GroupMemberSecurityRequestArrayWrapper**](../../models/group-member-security-request-array-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

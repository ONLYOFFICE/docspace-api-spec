...
|------------- | ------------- | ------------- | -------------|
| **200** | The entry the token points at, with the validation status of the link | [**ExternalShareWrapper**](../../models/external-share-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

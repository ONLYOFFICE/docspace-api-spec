...
|------------- | ------------- | ------------- | -------------|
| **200** | true if new documents are created with the default name | [**BooleanWrapper**](../../models/boolean-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

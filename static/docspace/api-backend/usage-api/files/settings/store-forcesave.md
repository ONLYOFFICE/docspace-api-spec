...
|------------- | ------------- | ------------- | -------------|
| **200** | Always false: forcesaved versions are not kept separately | [**BooleanWrapper**](../../models/boolean-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

...
|------------- | ------------- | ------------- | -------------|
| **200** | true if the caller sees rooms arranged by room groups | [**BooleanWrapper**](../../models/boolean-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

...
|------------- | ------------- | ------------- | -------------|
| **200** | true if the room lifetime warning is now hidden for the caller | [**BooleanWrapper**](../../models/boolean-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

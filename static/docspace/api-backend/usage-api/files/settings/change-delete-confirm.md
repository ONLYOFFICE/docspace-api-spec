...
|------------- | ------------- | ------------- | -------------|
| **200** | true if the caller is asked to confirm a deletion | [**BooleanWrapper**](../../models/boolean-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

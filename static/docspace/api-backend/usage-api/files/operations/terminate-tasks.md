...
|------------- | ------------- | ------------- | -------------|
| **200** | The operations of the caller that are left after the cancellation | [**FileOperationArrayWrapper**](../../models/file-operation-array-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

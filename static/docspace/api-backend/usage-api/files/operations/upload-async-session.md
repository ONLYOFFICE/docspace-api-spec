...
|------------- | ------------- | ------------- | -------------|
| **200** | The session with its progress after the part was stored | [**ChunkedUploadSessionResponseIntegerWrapper**](../../models/chunked-upload-session-response-integer-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

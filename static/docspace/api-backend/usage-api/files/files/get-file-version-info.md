...
|------------- | ------------- | ------------- | -------------|
| **200** | Every stored version of the file, newest first | [**FileIntegerArrayWrapper**](../../models/file-integer-array-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

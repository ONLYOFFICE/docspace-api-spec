...
| **CustomFilterParameters** | body | [**CustomFilterParameters**](../../models/custom-filter-parameters.md) | The Custom Filter state to reach. | [required] |

## Responses

| Status code | Description | Type | Response headers |
|------------- | ------------- | ------------- | -------------|
| **200** | The spreadsheet with its Custom Filter state as it now stands | [**FileIntegerWrapper**](../../models/file-integer-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

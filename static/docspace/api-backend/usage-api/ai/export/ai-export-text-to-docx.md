...
|------------- | ------------- | ------------- | -------------|
| **202** | Confirms the export was queued. The .docx arrives in the target folder later, announced by a folder-modified socket event. | [**aiExportTextToDocx_202_response**](../../models/ai-export-text-to-docx-202-response.md) | - |
| **400** | `title`, `content` or `folderId` is missing. | [**AiErrorResponse**](../../models/ai-error-response.md) | - |

...
|------------- | ------------- | ------------- | -------------|
| **200** | The editor address to open, with an optional notice fragment | [**StringWrapper**](../files.md#model-stringwrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

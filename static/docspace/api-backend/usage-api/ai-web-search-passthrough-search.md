...
| **404** | Web search is not configured for this portal. | [**AiErrorResponse**](../aichat.md#model-aierrorresponse) | - |
...
| **429** | Relayed verbatim from the AI provider, which is rate-limiting this portal&#39;s key. | [**AiErrorResponse**](../aichat.md#model-aierrorresponse) | - |

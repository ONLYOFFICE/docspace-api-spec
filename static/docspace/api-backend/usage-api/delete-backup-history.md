...
|------------- | ------------- | ------------- | -------------|
| **200** | True once every record has been walked, whether or not all of them were deleted | [**BooleanWrapper**](../backup.md#model-booleanwrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

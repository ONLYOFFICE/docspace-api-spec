...
|------------- | ------------- | ------------- | ------------- | -------------|
| **aiToolsSetAllowAlways\_request** | body | [**aiToolsSetAllowAlways_request**](../aichat.md#model-aitoolssetallowalways-request-body) |  | [required] |

## Responses

| Status code | Description | Type | Response headers |
|------------- | ------------- | ------------- | -------------|
| **200** | Confirms the always-allow list was updated. | [**AiSuccessResponse**](../aichat.md#model-aisuccessresponse) | - |

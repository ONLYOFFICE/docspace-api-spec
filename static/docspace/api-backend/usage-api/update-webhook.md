...
|------------- | ------------- | ------------- | -------------|
| **200** | Updated tenant webhook with its config parameters | [**WebhooksConfigWrapper**](../api.md#model-webhooksconfigwrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

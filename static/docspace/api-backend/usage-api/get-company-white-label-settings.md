...
|------------- | ------------- | ------------- | -------------|
| **200** | Company white label settings | [**CompanyWhiteLabelSettingsWrapper**](../api.md#model-companywhitelabelsettingswrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |
| **401** | Unauthorized | - | - |

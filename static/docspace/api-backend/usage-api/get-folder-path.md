...
|------------- | ------------- | ------------- | -------------|
| **200** | The chain of folders leading to the folder, the section root first | [**FileEntryBaseArrayWrapper**](../files.md#model-fileentrybasearraywrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

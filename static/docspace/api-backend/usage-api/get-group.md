...
|------------- | ------------- | ------------- | -------------|
| **200** | The group, with its members when includeMembers was set | [**GroupWrapper**](../people.md#model-groupwrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

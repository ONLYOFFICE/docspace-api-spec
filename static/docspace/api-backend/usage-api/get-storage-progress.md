...
|------------- | ------------- | ------------- | -------------|
| **200** | Migration progress as a percentage, or -1 where storage migration is not offered | [**DoubleWrapper**](../api.md#model-doublewrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

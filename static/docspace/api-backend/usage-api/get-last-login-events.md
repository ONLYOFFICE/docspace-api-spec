...
|------------- | ------------- | ------------- | -------------|
| **200** | The twenty most recent login events of the portal, newest first | [**LoginEventArrayWrapper**](../api.md#model-logineventarraywrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

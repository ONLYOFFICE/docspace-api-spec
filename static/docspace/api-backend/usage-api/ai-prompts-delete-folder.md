...
|------------- | ------------- | ------------- | -------------|
| **200** | Confirms the folder and the prompts inside it are gone. | [**AiSuccessResponse**](../newai.md#model-aisuccessresponse) | - |
...
| **404** | No prompt folder has this ID. | [**AiErrorResponse**](../newai.md#model-aierrorresponse) | - |

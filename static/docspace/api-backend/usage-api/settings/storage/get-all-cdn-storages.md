...
|------------- | ------------- | ------------- | -------------|
| **200** | The storages that can serve as the portal CDN, with the one in use marked as current | [**StorageArrayWrapper**](../../models/storage-array-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

...
|------------- | ------------- | ------------- | -------------|
| **200** | Saved default AI agent storage quota settings | [**TenantAiAgentQuotaSettingsWrapper**](../../models/tenant-ai-agent-quota-settings-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |
...
[**TenantAiAgentQuotaSettingsWrapper**](../../models/tenant-ai-agent-quota-settings-wrapper.md)

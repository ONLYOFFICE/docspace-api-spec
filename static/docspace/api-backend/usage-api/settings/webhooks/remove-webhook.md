...
|------------- | ------------- | ------------- | -------------|
| **200** | The removed webhook subscription, as it was just before the removal | [**WebhooksConfigWrapper**](../../models/webhooks-config-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

...
|------------- | ------------- | ------------- | -------------|
| **200** | The newly queued delivery record, with its status and delivery moment not filled in yet | [**WebhooksLogWrapper**](../../models/webhooks-log-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |
...
[**WebhooksLogWrapper**](../../models/webhooks-log-wrapper.md)

...
|------------- | ------------- | ------------- | -------------|
| **200** | The built-in resource flags that are now in effect | [**AdditionalWhiteLabelSettingsResponseWrapper**](../../models/additional-white-label-settings-response-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |
...
[**AdditionalWhiteLabelSettingsResponseWrapper**](../../models/additional-white-label-settings-response-wrapper.md)

...
|------------- | ------------- | ------------- | -------------|
| **200** | A page of wallet movements with its paging information, or an empty result when the portal has no billing customer | [**ReportWrapper**](../../models/report-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |
...
[**ReportWrapper**](../../models/report-wrapper.md)

...
|------------- | ------------- | ------------- | -------------|
| **200** | The allowance the current tariff grants this portal, with sizes in bytes | [**TenantQuotaWrapper**](../../models/tenant-quota-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

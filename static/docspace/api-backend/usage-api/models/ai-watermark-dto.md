...
|------------ | ------------- | ------------- | -------------|
| **additions** | [**AiWatermarkAdditions**](ai-watermark-additions.md) | Which details of the reader and of the room are stamped alongside the text. The values combine, so a number  that is not a member on its own is the sum of several of them, and 0 means that only the text is stamped. | [required] [enum: `1`, `2`, `4`, `8`, `16`] |

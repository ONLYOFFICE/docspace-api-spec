...
| **items** | [**List**](room-new-items-dto.md) | What changed on that day, the most recent first. Folders are left out of it, so an entry here is always a file  or a room that holds them. | [required] [nullable] |

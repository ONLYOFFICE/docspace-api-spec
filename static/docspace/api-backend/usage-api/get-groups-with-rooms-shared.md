...
|------------- | ------------- | ------------- | -------------|
| **200** | The matching groups, each with its access state for the room | [**GroupArrayWrapper**](../people.md#model-grouparraywrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

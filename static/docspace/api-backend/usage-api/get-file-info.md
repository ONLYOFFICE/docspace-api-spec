...
|------------- | ------------- | ------------- | -------------|
| **200** | The file as it is stored, with the state it has for the caller | [**FileIntegerWrapper**](../files.md#model-fileintegerwrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

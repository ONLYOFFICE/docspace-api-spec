...
|------------- | ------------- | ------------- | -------------|
| **200** | The matching users and groups, each with its access state for the folder | [**IAccountEntryArrayWrapper**](../../models/i-account-entry-array-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

...
|------------- | ------------- | ------------- | -------------|
| **200** | The interface theme of the calling account | [**DarkThemeSettingsWrapper**](../../models/dark-theme-settings-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

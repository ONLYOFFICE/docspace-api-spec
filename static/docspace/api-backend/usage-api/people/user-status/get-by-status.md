...
|------------- | ------------- | ------------- | -------------|
| **200** | A page of accounts in the requested state, with their full profiles | [**EmployeeFullArrayWrapper**](../../models/employee-full-array-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

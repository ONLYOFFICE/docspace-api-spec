...
|------------- | ------------- | ------------- | -------------|
| **200** | The profile whose password was changed | [**EmployeeFullWrapper**](../../models/employee-full-wrapper.md) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

...
|------------- | ------------- | ------------- | -------------|
| **200** | The stored file, as a list with one element | [**FileArrayWrapper**](../files.md#model-filearraywrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

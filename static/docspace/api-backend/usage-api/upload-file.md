...
|------------- | ------------- | ------------- | -------------|
| **200** | The stored file, as a list with one element | [**FileIntegerArrayWrapper**](../files.md#model-fileintegerarraywrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

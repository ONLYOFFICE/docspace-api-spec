...
|------------- | ------------- | ------------- | ------------- | -------------|
| **aiThreadsTouch\_request** | body | [**aiThreadsTouch_request**](../aichat.md#model-aithreadstouch-request-body) |  | [required] |

## Responses

| Status code | Description | Type | Response headers |
|------------- | ------------- | ------------- | -------------|
| **200** | Confirms the thread&#39;s activity date moved forward. | [**AiSuccessResponse**](../aichat.md#model-aisuccessresponse) | - |

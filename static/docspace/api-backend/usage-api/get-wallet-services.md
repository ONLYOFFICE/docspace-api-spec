...
|------------- | ------------- | ------------- | -------------|
| **200** | The wallet services on offer, with their prices, units and grouped variants | [**WalletServiceArrayWrapper**](../api.md#model-walletservicearraywrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |
...
[**WalletServiceArrayWrapper**](../api.md#model-walletservicearraywrapper)

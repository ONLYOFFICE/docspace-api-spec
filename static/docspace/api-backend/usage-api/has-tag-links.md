...
|------------- | ------------- | ------------- | -------------|
| **200** | True when at least one room still carries the tag | [**BooleanWrapper**](../files.md#model-booleanwrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

...
|------------- | ------------- | ------------- | -------------|
| **200** | List of filtered audit trail data | [**AuditEventArrayWrapper**](../api.md#model-auditeventarraywrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

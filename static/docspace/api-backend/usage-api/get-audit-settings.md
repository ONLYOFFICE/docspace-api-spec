...
|------------- | ------------- | ------------- | -------------|
| **200** | Audit settings | [**TenantAuditSettingsResponseWrapper**](../api.md#model-tenantauditsettingsresponsewrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

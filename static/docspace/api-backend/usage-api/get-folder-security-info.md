...
|------------- | ------------- | ------------- | -------------|
| **200** | The accounts and groups that hold rights on the folder, the owner first | [**FileShareArrayWrapper**](../files.md#model-filesharearraywrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

...
|------------- | ------------- | ------------- | -------------|
| **200** | The wallet auto top up settings | [**TenantWalletSettingsWrapper**](../api.md#model-tenantwalletsettingswrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |
...
[**TenantWalletSettingsWrapper**](../api.md#model-tenantwalletsettingswrapper)

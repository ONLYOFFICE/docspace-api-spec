...
|------------- | ------------- | ------------- | -------------|
| **200** | The application with the enabled state and the settings of the current portal | [**AppWrapper**](../api.md#model-appwrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

...
|------------- | ------------- | ------------- | -------------|
| **200** | The full set of file settings for the caller and the portal | [**FilesSettingsWrapper**](../files.md#model-filessettingswrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

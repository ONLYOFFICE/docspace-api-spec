...
|------------- | ------------- | ------------- | -------------|
| **200** | The stored draft, whose ID links it to a message later. | [**AiAttachment**](../newai.md#model-aiattachment) | - |
| **400** | The attachment payload is malformed. | [**AiErrorResponse**](../newai.md#model-aierrorresponse) | - |

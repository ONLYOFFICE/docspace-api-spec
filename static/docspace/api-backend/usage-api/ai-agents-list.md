...
|------------- | ------------- | ------------- | -------------|
| **200** | The agent rooms, in the DocSpace AI service's folder-content envelope. | [**AiFolderContentIntegerWrapper**](../aichat.md#model-aifoldercontentintegerwrapper) | - |
...
[**AiFolderContentIntegerWrapper**](../aichat.md#model-aifoldercontentintegerwrapper)

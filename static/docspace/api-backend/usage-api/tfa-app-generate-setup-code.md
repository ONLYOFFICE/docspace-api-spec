...
|------------- | ------------- | ------------- | -------------|
| **200** | Setup code | [**SetupCodeWrapper**](../api.md#model-setupcodewrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |
...
[**SetupCodeWrapper**](../api.md#model-setupcodewrapper)

...
|------------- | ------------- | ------------- | -------------|
| **200** | Tenant room quota settings | [**TenantRoomQuotaSettingsWrapper**](../api.md#model-tenantroomquotasettingswrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

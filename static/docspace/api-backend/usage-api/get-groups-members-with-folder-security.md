...
|------------- | ------------- | ------------- | -------------|
| **200** | The members of the group with the access each of them has on the folder | [**GroupMemberSecurityRequestArrayWrapper**](../files.md#model-groupmembersecurityrequestarraywrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

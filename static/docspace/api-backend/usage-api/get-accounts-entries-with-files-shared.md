...
|------------- | ------------- | ------------- | -------------|
| **200** | The matching users and groups, each with its access state for the file | [**IAccountEntryArrayWrapper**](../people.md#model-iaccountentryarraywrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

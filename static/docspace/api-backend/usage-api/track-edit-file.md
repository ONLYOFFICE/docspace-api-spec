...
|------------- | ------------- | ------------- | -------------|
| **200** | The session was refreshed or closed | [**ItemKeyValuePairBooleanStringWrapper**](../files.md#model-itemkeyvaluepairbooleanstringwrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

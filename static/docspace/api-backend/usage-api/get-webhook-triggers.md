...
|------------- | ------------- | ------------- | -------------|
| **200** | List of triggers with availability for the current user | [**WebhookTriggerArrayWrapper**](../api.md#model-webhooktriggerarraywrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |

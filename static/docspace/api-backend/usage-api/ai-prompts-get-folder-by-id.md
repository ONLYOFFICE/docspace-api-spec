...
|------------- | ------------- | ------------- | -------------|
| **200** | The folder, or an empty body when no folder of the caller&#39;s has that ID. | [**AiPromptFolder**](../newai.md#model-aipromptfolder) | - |
| **400** | The folder ID is missing. | [**AiErrorResponse**](../newai.md#model-aierrorresponse) | - |

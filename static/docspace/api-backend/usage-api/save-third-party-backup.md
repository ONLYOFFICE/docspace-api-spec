...
|------------- | ------------- | ------------- | -------------|
| **200** | The root folder of the backup storage account | [**ThirdPartyFolderWrapper**](../files.md#model-thirdpartyfolderwrapper) | `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` |
